                                                    ...
                                                    <div class="homec-agent">
                                                        ...
                                                        <div class="homec-agent__body">
                                                         <h4 class="homec-agent__title position_relitive">
                                                            ...
                                                            <a href="{{ route('agent', ['agent_type' => 'agent', 'user_name' => html_decode($slider_agent->user_name)]) }}">{{ html_decode($slider_agent->name) }}

                                                                @php
                                                                $kyc = Modules\Kyc\Entities\KycInformation::where('user_id',$slider_agent->id)->where('status',1)->first();
                                                                @endphp
                                                                @if($kyc)
