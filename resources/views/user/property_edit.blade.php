                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-12">
                                        ...
                                        <div class="mg-top-20">
                                            ...
                                            <div class="form-group homec-form-input">
                                                <input type="date" name="date_form" value="{{ $property->date_form }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-12">
                                        ...
                                        <div class="mg-top-20">
                                            ...
                                            <div class="form-group homec-form-input">
                                                <input type="date" name="date_to" value="{{ $property->date_to }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-12">
                                        ...
                                        <div class="mg-top-20">
                                            ...
                                            <div class="form-group homec-form-input">
                                                <input type="time" name="time_form" value="{{ $property->time_form }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-12">
                                        ...
                                        <div class="mg-top-20">
                                            ...
                                            <div class="form-group homec-form-input">
                                                <input type="time" name="time_to" value="{{ $property->time_to }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
