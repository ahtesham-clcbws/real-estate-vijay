            ...
            <form action="{{ route('admin.property.update', $property->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4>{{__('admin.Booking Information')}}</h4>
                                <hr>
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="">{{__('admin.Date Form')}} </label>
                                            <input type="date" name="date_form" class="form-control" value="{{ $property->date_form }}">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="">{{__('admin.Date To')}} </label>
                                            <input type="date" name="date_to" class="form-control" value="{{ $property->date_to }}">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="">{{__('admin.Time Form')}} </label>
                                            <input type="time" name="time_form" class="form-control" value="{{ $property->time_form }}">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="">{{__('admin.Time To')}} </label>
                                            <input type="time" name="time_to" class="form-control" value="{{ $property->time_to }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
