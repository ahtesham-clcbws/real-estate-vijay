                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="date_form" class="form-control" value="{{ old('date_form') }}">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="">{{__('admin.Time From')}} </label>
                                            <input type="time" name="time_form" class="form-control" value="{{ old('time_form') }}">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
