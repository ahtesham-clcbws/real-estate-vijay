            ...
            <div class="row">
                <div class="col-lg-8 ol-12">
                    <div class="list-group homec-list-tabs homec-list-tabs--v2" id="list-tab" role="tablist">
                        ...
                        <a class="list-group-item" data-bs-toggle="list" href="#homec-pd-tab6" role="tab">{{__('user.Booking')}} </a>
                    ...
                    <div class="homec-pdetails-tab">
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <!--  End Property Review -->
                            <!--  Property Booking -->
                            <div class="tab-pane fade" id="homec-pd-tab6" role="tabpanel">
                                <div class="homec-pdetails-tab__inner">
                                    <div class="homec-submit-form">
                                        <div class="homec-submit-form mg-top-40">
                                            <h4 class="homec-submit-form__title">{{__('user.Booking Scheduling')}}</h4>
                                            <div class="homec-submit-form__inner">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-12">
                                                        <div class="mg-top-20">
                                                            <strong>Date:</strong> {{ \Carbon\Carbon::parse($property->date_form)->format('j M Y') }} - {{ \Carbon\Carbon::parse($property->date_to)->format('j M Y') }}
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-12">
                                                        <!-- Single Form Element -->
                                                        <div class="mg-top-20">
                                                            <strong>Time: </strong> {{ \Carbon\Carbon::parse($property->time_form)->format('g:i A') }} - {{ \Carbon\Carbon::parse($property->time_to)->format('g:i A') }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <h4 class="homec-submit-form__title">{{__('user.Booking Details')}}</h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="mg-top-20">
                                                            ...
                                                            <div class="form-group homec-form-input">
                                                                <input type="number" name="guests" id="slug" value="{{ old('guests') }}" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-12">
                                                        ...
                                                        <div class="mg-top-20">
                                                            ...
                                                            <div class="form-group homec-form-input">
                                                                <select  name="city" class="homec-form-select homec-border select2 home_form_select2">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="mg-top-20">
                                                            ...
                                                            <div class="form-group homec-form-input">
                                                                <textarea name="comment" id="comment" cols="30" rows="10" required>{{ old('comment') }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-12 d-flex justify-content-end mg-top-40">
                                                            <button type="submit" class="homec-btn homec-btn__second"><span>{{__('user.Confirmed Booking')}}</span></button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="card mb-4">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text">Date: {{ \Carbon\Carbon::parse($booking->booking_date)->format('j M Y') }} {{ \Carbon\Carbon::parse($booking->booking_time)->format('g:i A') }} </p>
                                                        @if($booking->status == 0)
                                                            <strong class="card-text">Status: </strong>Pending
                                                        @else
                                                            <strong class="card-text">Status: </strong>Confirmed
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
